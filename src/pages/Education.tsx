            ...
            <CardContent className="pt-6">
              <div className="flex justify-between items-start mb-4">
                <div>
                  ...
                  <p className="text-accent font-medium">MSc</p>
                  <p className="text-sm text-muted-foreground">Cell Biology / Cancer Research / Organoid Models</p>
                </div>
                <div className="text-right">
            ...
            <CardContent className="pt-6">
              <div className="flex justify-between items-start mb-4">
                <div>
                  ...
                  <p className="text-accent font-medium">BSc</p>
                  <p className="text-sm text-muted-foreground">Biology / Immunology / Microbiology</p>
                </div>
                <div className="text-right">
