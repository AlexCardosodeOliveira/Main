              ...
              <CardContent className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mb-3">
                    <a href="https://celldynamicslab.mystrikingly.com/" target="_blank" rel="noopener noreferrer" className="text-accent hover:underline inline-flex items-center gap-1">Cell Dynamics / Systems Biology <ExternalLink size={12} /></a> (Dr. Sheng-hong Chen), Taipei, Taiwan
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mb-3">
                    Cancer / Stem Cell Dynamics (<a href="https://mhs.biol.ethz.ch/research/gehart.html" target="_blank" rel="noopener noreferrer" className="text-accent hover:underline inline-flex items-center gap-1">Prof. Dr. Helmuth Gehart <ExternalLink size={12} /></a>), Zurich, Switzerland
                  </p>
                  <ul className="list-disc list-inside text-sm space-y-1">
